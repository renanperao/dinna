...
--  * Anon: ZERO acesso. Authenticated: SELECT apenas em dados do proprio restaurante,
--    para o Realtime do /kitchen funcionar.
...
-- =========================================================================
-- 2) Helper: retorna o restaurant_id do usuario autenticado
-- =========================================================================
...
--    e somente dados do proprio restaurante.
--    Escritas continuam via Drizzle no server.
-- =========================================================================

-- USERS: ve apenas a si mesmo
DROP POLICY IF EXISTS users_select_self ON public.users;
CREATE POLICY users_select_self ON public.users
  FOR SELECT TO authenticated
  USING (id = auth.uid());

-- ORDERS: ve pedidos do seu restaurante
...
-- ORDER_ITEMS: ve itens dos pedidos do seu restaurante
...
-- CUSTOMERS: ve clientes do seu restaurante
...
-- =========================================================================
-- O Supabase ja cria a publication `supabase_realtime`. Adicionamos orders
-- explicitamente caso ainda nao esteja la.
DO $$
BEGIN
